...
public class ItalianTruck_OrdersClosed extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_italian_orders_closed);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.orders_open:
                ...
                Intent openOrders = new Intent(this, ItalianTruck_OrdersOpen.class);
